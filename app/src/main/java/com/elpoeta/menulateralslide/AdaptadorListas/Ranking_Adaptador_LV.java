...
public class Ranking_Adaptador_LV extends BaseAdapter {
    ...
    int[] imagenes_ra;
    String[] listPts_ra;
    String[] listPuesto_ra;
    LayoutInflater inflater;

    public Ranking_Adaptador_LV(Context context, String[] equipos_ra, int[] imagenes_ra, String[] listPts_ra, String[] listPuesto_ra) {
        this.context = context;
        this.equipos_ra = equipos_ra;
        this.imagenes_ra = imagenes_ra;
        this.listPts_ra = listPts_ra;
        this.listPuesto_ra = listPuesto_ra;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        txtListPuesto_ra = (TextView) itemView.findViewById(R.id.txt_puesto_r);
        ...
        txtListPuesto_ra.setText(listPuesto_ra[position]);
